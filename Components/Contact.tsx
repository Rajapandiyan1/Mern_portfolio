export default function Contact () {
    ...
    return <section id='contact' style={{alignItems:'center',minHeight:'90vh'}} className='flex bg-indigo-light flex-col  px-5 justify-center text-white'>
        <div style={{alignItems:'center'}} className='flex flex-col '>
            ...
            <p className='py-2'><span className='font-bold'><a className="text-white"  href="mailto:rajapandiyan1163@gmail.com">Email : {config.email}</a></span></p>
            <p className='py-2'><span className='font-bold'><a  className="text-white" href="tel:9080883914">Phone : {config.phone}</a></span></p>        </div>
    </section>
}